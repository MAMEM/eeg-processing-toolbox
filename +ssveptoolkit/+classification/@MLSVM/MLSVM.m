classdef MLSVM < ssveptoolkit.classification.ClassifierBase
    ...
    methods (Access = public)
        function MLSVM = MLSVM(instanceSet, coding, fitPosterior, prior, tmpltsvm)
