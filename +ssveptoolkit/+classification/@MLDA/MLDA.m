classdef MLDA < ssveptoolkit.classification.ClassifierBase
    ...
    methods (Access = public)
        function MLDA = MLDA(instanceSet, discrimType, delta, gamma, fillCoeffs, scoreTransform,prior)
...
%             end
        ...
        function configInfo = getConfigInfo(MLDA)
            configInfo = sprintf('MLDA\tdiscrimtype:%s\tdelta:%f\tgamma:%f\tfillcoeffs:%d\tscoretransform:%s\tprior:%s',MLDA.DiscrimType, MLDA.Delta, MLDA.Gamma, MLDA.FillCoeffs, MLDA.ScoreTransform, MLDA.Prior);
        end
