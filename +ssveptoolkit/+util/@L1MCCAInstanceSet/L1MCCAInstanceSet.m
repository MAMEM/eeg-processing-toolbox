...
classdef L1MCCAInstanceSet < ssveptoolkit.util.InstanceSet
    ...
    methods
        function L1 = L1MCCAInstanceSet(trials)
            ...
            L1 = L1@ssveptoolkit.util.InstanceSet(zeros(1,1000),ones(1,1000));
            if(nargin>0)
        ...
        function newL1 = removeInstancesWithIndices(L1,indices)
            newL1 = ssveptoolkit.util.L1MCCAInstanceSet;
