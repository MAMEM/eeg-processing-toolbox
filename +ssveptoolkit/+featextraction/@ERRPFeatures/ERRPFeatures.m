classdef ERRPFeatures < ssveptoolkit.featextraction.PSDExtractionBase%FeatureExtractionBase
...
%             numFeatures = floor(numSamples/ERRP.downSampleFactor);
            ...
            ERRP.instanceSet = ssveptoolkit.util.InstanceSet(instances, labels);
        end
