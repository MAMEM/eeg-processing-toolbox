classdef L1MCCA < ssveptoolkit.featextraction.PSDExtractionBase%FeatureExtractionBase
    %
    ...
    methods (Access = public)
        ...
        function extract(L1MCCA)
            L1MCCA.instanceSet = ssveptoolkit.util.L1MCCAInstanceSet(L1MCCA.trials);
        end
