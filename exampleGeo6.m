...
% occipital = [138 150 139];
% 140 &150 &139 &137 &149 &125
...
aggr = ssveptoolkit.aggregation.LateFusionAggregator;

baseClassifier = ssveptoolkit.classifier.LIBSVMClassifier;
classif = ssveptoolkit.classifier.FusionClassifierWrapper(baseClassifier);
