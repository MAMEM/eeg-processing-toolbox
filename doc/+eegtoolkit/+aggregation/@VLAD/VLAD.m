classdef VLAD < eegtoolkit.aggregation.AggregatorBase;
    ...
    methods
        ...
        function VA = aggregate(VA)
            ...
            VA.instanceSet = eegtoolkit.util.InstanceSet(vlads,VA.featextractors{1}.getLabels);
        end
    ...
    methods (Static)
        function [] = trainCodebook(session, channels, numCenters, codebookfilename)
            ...
            for i=1:length(channels)
                ...
                extractors{i} = eegtoolkit.transformer.PWelchTransformer;
