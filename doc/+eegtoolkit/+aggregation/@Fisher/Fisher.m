classdef Fisher < eegtoolkit.aggregation.AggregatorBase
    properties
        codebookInfo;
        numClusters;
        means;
    ...
    methods
        ...
        function FA = aggregate(FA)
            ...
            FA.instanceSet = eegtoolkit.util.InstanceSet(fishers,FA.featextractors{1}.getLabels);
        end
    ...
    methods (Static)
        function [] = trainCodebook(session, channels, numCenters, codebookfilename,pcanum)
            ...
            for i=1:length(channels)
                ...
                extractors{i} = eegtoolkit.featextraction.PWelch;
